  ...
  return (
    <Transition.Root show={isOpen} as={Fragment}>
      <Dialog as="div" className="fixed inset-0 z-50 pt-8" onClose={setIsOpen}>
        <div className="flex min-h-[800px] items-start justify-center px-4 pb-20 pt-4 text-center sm:block sm:min-h-screen sm:p-0">
          <Transition.Child
            as={Fragment}
            ...
            <div className="inline-block transform overflow-hidden rounded-2xl bg-black text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-xl sm:align-middle">
              <div className="flex items-center border-b border-gray-700 px-1.5 py-2">
                <div
                  ...
                  <HiX className="h-[22px] w-[22px] text-white" />
                </div>
              </div>
              <div className="flex px-4 pb-2.5 pt-5 sm:px-6">
                    ...
                    <div className="mt-2 flex-grow">
                      ...
                      <div className="flex items-center justify-between pt-2.5">
                        <div className="flex items-center">
                          <div className="icon">
                            <HiPhotograph className="h-[22px] w-[22px] text-[#1d9bf0]" />
                          </div>

                          <div className="icon rotate-90">
                            <HiChartBar className="h-[22px] w-[22px] text-[#1d9bf0]" />
                          </div>
                          ...
                          <div className="icon">
                            <HiCalendar className="h-[22px] w-[22px] text-[#1d9bf0]" />
                          </div>
                        </div>
                        <button
